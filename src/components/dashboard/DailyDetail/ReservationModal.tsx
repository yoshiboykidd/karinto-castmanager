...
export default function ReservationModal({ 
  ...
  const customerInfo = useMemo(() => {
    try {
      ...
      console.error("History calculation error:", e);
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center">
      ...
      {/* 📍 トースト通知：特殊な animate-in などを排除し、標準的な Tailwind で実装 */}
      {showToast && (
        <div className="fixed top-10 left-1/2 -translate-x-1/2 z-[110] transition-opacity duration-300">
          <div className="bg-pink-600 text-white px-6 py-3 rounded-full shadow-2xl flex items-center gap-2 border border-pink-400">
