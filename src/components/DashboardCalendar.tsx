    ...
    <div className="w-full select-none">
      ...
      <div className="grid grid-cols-7 gap-y-1">
        {calendarDays.map((day) => {
          ...
          const isRequested = shift?.status === 'requested'; // 申請中
          ...
          // 💡 特定日 (10, 11, 20) の黄色背景
          const isSpecialDay = isCurrentMonth && [10, 11, 20].includes(dayNum);
          ...
          return (
            ...
            >
              ...
              {/* 日付テキスト */}
              <span className={`
                relative z-10 text-[16px] font-black tracking-tighter
                ${isOfficial ? 'text-pink-500' : isRequested ? 'text-purple-500' : 'text-gray-600'}
              `}>
                {dayNum}
              </span>
