  ...
  return (
    <div className="min-h-screen bg-[#FFF9FA] text-gray-800 pb-40 font-sans overflow-x-hidden">
      ...
      <header className="bg-white px-5 pt-12 pb-5 rounded-b-[30px] shadow-sm border-b border-pink-100">
        <p className="text-[10px] font-black text-pink-300 uppercase tracking-widest mb-1">KarintoCastManager ver 2.1.10</p>
      ...
      <main className="px-3 mt-3 space-y-3">
        ...
        {/* ✨ 実績合計：1行固定・中央寄せ・色味復元版 */}
        <section className="bg-[#FFE9ED] rounded-[24px] p-4 border border-pink-300 relative overflow-hidden shadow-sm flex flex-col items-center">
          ...
          <div className="relative z-10 w-full flex flex-col items-center">
            {/* 1. タイトル中央寄せ */}
            <h2 className="text-[16px] font-black text-pink-500 mb-3 tracking-tighter text-center leading-none">
              {format(viewDate, 'M月')}の実績合計
            </h2>

            {/* 2. バッジ：1行・中央寄せ・文字黒・数字ピンク */}
            <div className="flex flex-row items-center justify-center gap-3 mb-4 w-full flex-nowrap overflow-visible">
              <div className="bg-white/90 border border-pink-200 px-3 py-2 rounded-2xl flex items-baseline gap-1 shadow-sm shrink-0 min-w-[90px] justify-center">
                <span className="text-[11px] font-black text-gray-900 leading-none">出勤</span>
                <span className="text-2xl font-black text-pink-500 leading-none tracking-tighter">{monthlyTotals.count}</span>
                <span className="text-[11px] font-black text-gray-900 leading-none italic">日</span>
              </div>
              <div className="bg-white/90 border border-pink-200 px-3 py-2 rounded-2xl flex items-baseline gap-1 shadow-sm shrink-0 min-w-[90px] justify-center">
                <span className="text-[11px] font-black text-gray-900 leading-none">稼働</span>
                <span className="text-2xl font-black text-pink-500 leading-none tracking-tighter">{Math.round(monthlyTotals.hours * 10) / 10}</span>
                <span className="text-[11px] font-black text-gray-900 leading-none italic">h</span>
              </div>
            </div>
            ...
            {/* 4. 詳細内訳：中央寄せ */}
            <div className="grid grid-cols-3 gap-1 w-full max-w-[320px] bg-white/80 rounded-xl py-3 border border-pink-200 text-center shadow-inner">
        ...
        <p className="text-center text-[10px] font-bold text-gray-200 tracking-widest pb-8 uppercase">Karinto Cast Manager ver 2.1.10</p>
      </main>
