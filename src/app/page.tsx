        ...
        <section className="bg-white rounded-[24px] border border-pink-300 shadow-xl overflow-hidden">
          ...
          {selectedShift && (
            <div className="p-4 space-y-4">
              ...
              <button onClick={handleSaveReward} className="w-full bg-pink-500 text-white font-black py-5 rounded-xl text-xl shadow-lg active:scale-95 transition-all tracking-widest uppercase">実績を保存 💾</button>
            </div>
          )}
        </section>
